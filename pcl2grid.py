...
point_cloud_fname = f'{seq_name}_map_pts_and_keyframes.txt'
keyframe_trajectory_fname = f'{seq_name}_key_frame_trajectory.txt'
visit_counter_fname = f'{seq_name}_filtered_{filter_ground_points}_scale_{scale_factor}_visit_counter.txt'
occupied_counter_fname = f'{seq_name}_filtered_{filter_ground_points}_scale_{scale_factor}_occupied_counter.txt'
...
if load_counters:
    try:
        ...
        print(f'One or more counter files: {occupied_counter_fname}, {visit_counter_fname} could not be found')
        counters_loaded = False
